 ...
 */
public class InputDialogPaneBuilder extends StandardDialogPaneBuilder<DialogPane, InputDialogPaneBuilder, Map<String, Object>> {

	public InputDialogPaneBuilder() {
		super(DialogPane::new);
	}
	...
	public <T> InputDialogPaneBuilder add(String id, String label, Class<T> type, T dflt, InputDialog.InputControl<T> control) {
