...
/////////////////////////////////////////////////////////////////////////////
object Meta {
    const val DESCRIPTION = "JavaFX application support library."
...
dependencies {
    ...
    jacocoAggregation(project(":fx-application"))
    jacocoAggregation(project(":fx-application:fx-application-fxml"))
}
