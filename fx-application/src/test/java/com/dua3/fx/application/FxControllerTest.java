...
class FxControllerTest extends FxTestBase {
    ...
    void testGetAndSetCurrentDocument() {
        ...
        Assertions.assertFalse(controller.getCurrentDocument().isPresent(), 
            "Initially, there should be no current document");
        ...
        Assertions.assertTrue(controller.getCurrentDocument().isPresent(), 
            "After setting, there should be a current document");
        Assertions.assertEquals(doc, controller.getCurrentDocument().get(), 
            "The current document should be the one we set");
    }
    ...
    void testCreateDocument() {
        ...
        Assertions.assertTrue(controller.getCurrentDocument().isPresent(), 
            "After creating, there should be a current document");
        Assertions.assertEquals(FxDocument.VOID_URI, controller.getCurrentDocument().get().getLocation(), 
            "The new document should have VOID_URI as location");
    }
    ...
    void testLoadDocument() {
        ...
        Assertions.assertEquals(testUri, doc.getLocation(), 
            "The loaded document should have the specified URI as location");
        Assertions.assertEquals(doc, controller.getCurrentTestDocument(), 
            "The loaded document should be set as the current document");
    }
